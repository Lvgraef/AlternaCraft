...
import io.github.itskillerluc.alternacraft.block.*;
...
public class BlockRegistry {
    ...
    public static final DeferredBlock<PinkPetalsBlock> BLUE_PASTEL_PETALS = BLOCKS.registerBlock("blue_pastel_petals", PinkPetalsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_PETALS).mapColor(MapColor.COLOR_LIGHT_BLUE));
    ...
    public static final DeferredBlock<Block> LIGHTNING_MARSH = BLOCKS.registerSimpleBlock("lightning_marsh", BlockBehaviour.Properties.ofFullCopy(Blocks.GRASS_BLOCK));
    ...
    public static final DeferredBlock<SaplingBlock> RED_PASTELIZED_SAPLING = BLOCKS.registerBlock("red_pastelized_sapling", props -> new SaplingBlock(TreeGrowers.RED_PASTELIZED_TREE, props), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING));
    public static final DeferredBlock<SaplingBlock> BLUE_PASTELIZED_SAPLING = BLOCKS.registerBlock("blue_pastelized_sapling", props -> new SaplingBlock(TreeGrowers.BLUE_PASTELIZED_TREE, props), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING));
