package io.github.itskillerluc.alternacraft.worldgen.biome;
...
public class OverworldBiomes {
    ...
    public static Biome volcanicWasteland(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        biomegenerationsettings$builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_DEAD_BUSH_BADLANDS);
        return new Biome.BiomeBuilder()
